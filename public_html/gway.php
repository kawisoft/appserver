...
$config->serviceFolders = array(EXAMPLE_SERVICES);
$config->serviceFolders[] = array( NAMESPACE_SERVICES, 'NService');
$voFolders = array(VALUE_OBJECTS);

//add the folder with the namespace. 1st comes the pass, 2nd comes the namespace root.voFolders[] = array(NAMESPACE_VALUE_OBJECTS, 'NVo');
